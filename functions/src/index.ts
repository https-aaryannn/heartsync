...
export const onUserCreatedStats = functions.firestore
...
export const onCrushCreatedUpdateStats = functions.firestore
    .document('crushes/{crushId}')
    .onCreate(async (snap, context) => {
        const crush = snap.data() as Crush;
...
export const onMatchCreatedUpdateStats = functions.firestore
...
export const getStats = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        const statsResponse: any = {
            ...
            totalCrushes: globalData?.totalCrushes || 0,
            totalMatches: globalData?.totalMatches || 0,
            activePeriod
        };
...
export const recomputeStats = functions.https.onRequest(async (req, res) => {
    // Admin guard
    // ...
